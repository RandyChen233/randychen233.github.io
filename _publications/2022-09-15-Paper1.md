...
excerpt: '(**Accepted Jan 16, 2023**).In this work, we developed a scalable trajectory optimization algorithm that enables robots to interact with multiple humans and robots.'
date: 
venue: 'IEEE ICRA'
