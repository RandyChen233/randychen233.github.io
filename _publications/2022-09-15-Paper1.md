...
excerpt: '(**This work is under review for ICRA 2023 and is yet to be accepted**).In this work, we developed a scalable trajectory optimization algorithm that enables robots to interact with multiple humans and robots.'
date: 2022-09-15
venue: 'IEEE ICRA'
paperurl: 
citation: 
