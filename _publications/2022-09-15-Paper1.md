...
excerpt: '(**This work is under review and yet to be accepted**).In this work, we developed a scalable trajectory optimization algorithm that enables robots to interact with multiple humans and robots.'
date: 2023
venue: 'IEEE ICRA'
paperurl: 
citation: 
